!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){var d,e,f,g,h,i=function(a,b){function c(){this.constructor=a}for(var d in b)j.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},j={}.hasOwnProperty;e=a("../util/eventDispatcher"),f=a("../util/throttle"),h=null,d=function(a){function b(){var a,c,d;for(b.__super__.constructor.call(this),this.param=["x","y","z"],this.param_length=this.param.length,this.last_acc={},a=c=0,d=this.param_length;d>=0?d>c:c>d;a=d>=0?++c:--c)this.last_acc[this.param[a]]=0;this.thr=window.isAndroid?10:10.5}return i(b,a),b.prototype.exec=function(){var a;return a=new f(50),window.addEventListener("devicemotion",function(b){return function(c){return a.exec(function(){var a,d,e,f;for(f=[],a=d=0,e=b.param_length;e>=0?e>d:d>e;a=e>=0?++d:--d)b.last_acc[b.param[a]]=.9*b.last_acc[b.param[a]]+.1*Math.abs(c.accelerationIncludingGravity[b.param[a]]),b.last_acc[b.param[a]]>b.thr?f.push(b.dispatch("SHAKED")):f.push(void 0);return f})}}(this))},b}(e),g=function(){return h||(h=new d),h},b.exports=g},{"../util/eventDispatcher":5,"../util/throttle":6}],2:[function(a,b,c){/*!
  *
...
/*!
  ...
  *
 */
a("../js/velocity.min.js"),window._DEBUG?null!=Object.freeze?window.DEBUG=Object.freeze(window._DEBUG):window.DEBUG={state:!0}:null!=Object.freeze?window.DEBUG=Object.freeze({state:!1}):window.DEBUG={state:!1},window.DUR=500,$(function(){var b;return b=$(".wrapper-common").data("path"),"pitch"===b?a("./pitchInit")():"shake"===b?a("./shakeInit")():void 0})},{"../js/velocity.min.js":10,"./pitchInit":3,"./shakeInit":4}],3:[function(a,b,c){var d;d=function(){return a("./view/historyGraph")},b.exports=d},{"./view/historyGraph":9}],4:[function(a,b,c){var d,e,f;d=a("./controller/accelHandler")(),f=a("./util/ticker")(),e=function(){var a,b,c,e,g,h,i,j,k,l,m;return i=$(".wrapper-common"),a=$(".caution_container"),c=$(".qr_container"),h=$(".tutorial_container"),g=$(".soundBtn"),b=$(".fromSp"),e=$(".shake"),l=null,j=[],k=0,window.isSp?window.user_id=null:window.user_id=parseInt(1e3*Math.random()),m=function(){var d,e,f,j,m,n;if(!window.isSp)return $("<img>").attr({src:"http://chart.apis.google.com/chart?chs=480x480&cht=qr&chl="+(window.location.href+"?user_id="+window.user_id),alt:"QRコード"}).appendTo($(".qr")),i.one("click",function(){return c.velocity({opacity:[0,1]},DUR,function(){return c.hide()})}),l.on("send",function(a){return"ok"===a.value.action&&a.value.user_id===window.user_id?h.velocity({opacity:[0,1]},DUR,function(){return h.hide()}):void 0}),g.eq(k).addClass("on"),g.on("click",function(a){return alert($(a.currentTarget).data("num")),g.removeClass("on"),$(a.currentTarget).addClass("on"),l.send({user_id:window.user_id,action:"change",num:$(a.currentTarget).data("num")}),i.attr({"data-color":""+($(a.currentTarget).data("num")+1)})});if(f=window.location.search.substring(1),e=f.split("&"),e.length>0)for(j=m=0,n=e.length;n>=0?n>m:m>n;j=n>=0?++m:--m)if(d=e[j].split("="),"user_id"===decodeURIComponent(d[0])){window.user_id=parseInt(decodeURIComponent(d[1])),b.hide(),i.addClass("hide"),a.show(),l.send({user_id:window.user_id,action:"load"});break}return"block"!==a.css("display")?b.show():void 0},f.listen("CHECK_MILK",function(){var a;return null!=window.MilkCocoa?(f.clear("CHECK_MILK"),a=new window.MilkCocoa("juiceiajokl77.mlkcca.com"),l=a.dataStore("shake"),m()):void 0}),window.isSp&&a.find(".caution_ok").on("click",function(){var b,c;for(b=c=0;5>c;b=++c)j[b]=new Audio,j[b].src="audio/"+(b+1)+".mp3",j[b].play(),j[b].pause();return a.hide(),i.removeClass("hide"),e.show(),l.send({user_id:window.user_id,action:"ok"}),l.on("send",function(a){return"change"===a.value.action&&a.value.user_id===window.user_id?(alert(k),j[k].pause(),k=a.value.num,i.attr({"data-color":""+(a.value.num+1)})):void 0}),d.listen("SHAKED",function(){return j[k].paused?j[k].play():void 0}),d.exec()}),$("<script>").attr({src:"https://cdn.mlkcca.com/v2.0.0/milkcocoa.js"}).appendTo($("head")),i.addClass("color1"),window.isSp?(a.hide(),b.hide(),e.hide()):void 0},b.exports=e},{"./controller/accelHandler":1,"./util/ticker":7}],5:[function(a,b,c){var d,e=[].slice;d=function(){function a(){this.listeners={},this.dispatched={}}return a.prototype.listen=function(a,b){return null!=this.listeners[a]?this.listeners[a].push(b):this.listeners[a]=[b]},a.prototype.dispatch=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]){for(h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.first=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]&&null==this.dispatched[b]){for(this.dispatched[b]=!0,h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.clear=function(a){return null!=a?this.listeners[a]=null:this.listeners={}},a}(),b.exports=d},{}],6:[function(a,b,c){var d;d=function(){function a(a){this.is_first=!0,this.interval=a,this.prevTime=0,this.timer=null}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},a.prototype.exec=function(a){var b,c;return c=window.getNow(),b=c-this.prevTime,clearTimeout(this.timer),b>=this.interval?(this.prevTime=c,a()):this.timer=setTimeout(function(){return a()},this.interval)},a.prototype.first=function(a){return this.is_first?(this.is_first=!1,a()):(clearTimeout(this.firstTimer),this.firstTimer=setTimeout(function(a){return function(){return a.is_first=!0}}(this),this.interval))},a.prototype.last=function(a){return clearTimeout(this.lastTimer),this.lastTimer=setTimeout(function(){return a()},this.interval)},a.prototype.triggerend=function(){return this.is_first=!0},a}(),b.exports=d},{}],7:[function(a,b,c){var d,e,f;f=null,d=function(){function a(){var a;this.listeners={},this.start={},(a=function(b){return function(){var c;for(c in b.listeners)b.listeners[c](window.getNow()-b.start[c]);return window.requestAnimFrame(a)}}(this))()}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},null!=window.requestAnimationFrame?window.requestAnimFrame=window.requestAnimationFrame:null!=window.webkitRequestAnimationFrame?window.requestAnimFrame=window.webkitRequestAnimationFrame:null!=window.mozRequestAnimationFrame?window.requestAnimFrame=window.mozRequestAnimationFrame:window.requestAnimFrame=function(a){return window.setTimeout(a,1e3/60)},a.prototype.listen=function(a,b){return this.start[a]=window.getNow(),this.listeners[a]=b},a.prototype.clear=function(a){return null!=a?(delete this.listeners[a],delete this.start[a]):(this.listeners={},this.start={})},a}(),e=function(){return f||(f=new d),f},b.exports=e},{}],8:[function(a,b,c){var d;d=function(){function a(a){return this.canvas=a.get(0),this.canvas.getContext?void(this.ctx=this.canvas.getContext("2d")):void 0}return a.prototype.resetContext=function(a,b){return this.canvas.width=a,this.canvas.height=b},a.prototype.clear=function(){return this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)},a.prototype.drawDivisions=function(){return this.ctx.strokeStyle="red",this.ctx.beginPath(),this.ctx.moveTo(0,0),this.ctx.lineTo(0,256),this.ctx.moveTo(128,0),this.ctx.lineTo(128,256),this.ctx.moveTo(256,0),this.ctx.lineTo(256,256),this.ctx.moveTo(384,0),this.ctx.lineTo(384,256),this.ctx.moveTo(512,0),this.ctx.lineTo(512,256),this.ctx.stroke()},a.prototype.drawWave=function(a){var b,c,d,e;for(b=a.length,this.ctx.strokeStyle="black",this.ctx.beginPath(),this.ctx.moveTo(this.canvas.width-b+c,a[c]/100*this.canvas.height),c=d=0,e=b;e>=0?e>d:d>e;c=e>=0?++d:--d)this.ctx.lineTo(this.canvas.width-b+c,a[c]/100*this.canvas.height);return this.ctx.stroke()},a.prototype.getImgData=function(a,b,c,d){return this.ctx.getImageData(a,b,c,d)},a.prototype.getImg=function(){return this.canvas.toDataURL()},a.prototype.getContext=function(){return this.ctx},a}(),b.exports=d},{}],9:[function(a,b,c){var d,e,f,g,h;e=a("./canvasManager"),d=$("#history"),g=new e(d),g.resetContext(d.width(),d.height()),h=[],f=30,window.drawHistory=function(a){return g.clear(),g.drawDivisions(),h.push(a-f),g.drawWave(h)}},{"./canvasManager":8}],10:[function(a,b,c){/*! VelocityJS.org (1.2.2). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
